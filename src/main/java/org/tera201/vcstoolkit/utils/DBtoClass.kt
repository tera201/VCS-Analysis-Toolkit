...
fun toClass(graph: DigraphEdgeList<Int, String>, modelId:Int, dataBaseUtil: DataBaseUtil) {
    dataBaseUtil.getRootPackageIds(modelId).forEach { generatePackage(graph, null, dataBaseUtil, it, modelId) }
}


private fun generatePackage(graph: DigraphEdgeList<Int, String>, parent: Vertex<Int>?, dataBaseUtil: DataBaseUtil, id: Int, modelId:Int) {
...
private fun generateClass(graph: DigraphEdgeList<Int, String>, parent: Vertex<Int>?, dataBaseUtil: DataBaseUtil, id: Int, modelId:Int) {
...
private fun nestedClasses(graph: DigraphEdgeList<Int, String>, parent: Vertex<Int>?) {
...
private fun interfacesAsJava(graph: DigraphEdgeList<Int, String>, mainClass:Vertex<Int>, dataBaseUtil: DataBaseUtil, id: Int, modelId:Int) {
...
private fun parentsAsJava(graph: DigraphEdgeList<Int, String>, mainClass:Vertex<Int>, dataBaseUtil: DataBaseUtil, id: Int, modelId:Int) {
...
private fun generateEnumeration(graph: DigraphEdgeList<Int, String>, parent: Vertex<Int>?, dataBaseUtil: DataBaseUtil, id: Int, modelId:Int) {
...
private fun generateInterface(graph: DigraphEdgeList<Int, String>, parent: Vertex<Int>?, dataBaseUtil: DataBaseUtil, id: Int, modelId:Int) {
...
private fun tryInsertEdge(graph: DigraphEdgeList<Int, String>, node1: Vertex<Int>, node2: Vertex<Int>, arrowTypes: ArrowTypes) {
    try {
